...
public class Turtle {
    ...
    /**
     * creates a turtle facing North, positioned the middle of a new paper with width and height of 10
     */
    public Turtle() {
        this(new Paper(10, 10));
    }
    ...
    public Turtle(int x, int y, Direction direction, Paper paper) {
        this(x, y, direction, Pen.UP, paper);
    }

    public Turtle(int x, int y, Direction direction, Pen pen, Paper paper) {
        this.x = x;
        this.y = y;
    ...
    private void edgeOfPaper(int xOld, int yOld) {
